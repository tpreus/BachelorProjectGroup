...
experimentName = "test";
Xexperiment = "200Fapple.ply";
Yexperiment = "200Fsphere.ply";
numberFeatures = 40;
...
[VX, FX] = readPLY(Xexperiment);
[VY, FY] = readPLY(Yexperiment);
...
[A_equal, A_leq, b_equal, b_leq] = getConstraints(VX, FX, VY, FY, ListConstraints); %calculating constraints for the problem
...
if ListConstraints(1) ==3 % only relevant if constraint for double neighborhood with relaxation is added
